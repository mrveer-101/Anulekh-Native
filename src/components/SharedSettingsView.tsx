...
export default function SharedSettingsView() {
  ...
  const handleDeleteAccount = () => {
    Alert.alert(
      ...
      'Are you absolutely sure? This will delete your profile, exam requests, messages, and notifications permanently from the backend database. This action cannot be undone.',
      [
        { text: 'Cancel', style: 'cancel' },
        {
  ...
  return (
    <ScrollView style={{ flex: 1, paddingHorizontal: 20 }} contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
      ...
      >
        ...
        <Text style={{ color: '#64748b', fontWeight: '800', fontSize: 13 }}>{t('sign_out')}</Text>
      </TouchableOpacity>
